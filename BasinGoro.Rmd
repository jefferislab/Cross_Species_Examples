...
install.packages(c("nat.nblast","stringr","dendextend","rgl", "knitr"))
...
tanglegram(dsyn4, bghcd, margin_inner=8, margin_outer=8, columns_width = c(4,1.5,4))
```
...
tanglegram(bghcd, bghcd.pruned, margin_inner=8, margin_outer=8, columns_width = c(4,1.5,4))
```
